...
export function DocsDialog({ children, open, onOpenChange }: { children?: React.ReactNode, open?: boolean, onOpenChange?: (open: boolean) => void }) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            ...
            <DialogContent className="max-w-5xl! h-[85vh] pb-8">
                <div className="grid gap-4 md:grid-cols-[180px_1fr] h-full overflow-hidden">
                    <aside className="hidden md:flex flex-col gap-1 flex-none p-1 pt-6">
                        <h3 className="text-xs font-medium text-muted-foreground px-3 mb-2">Sections</h3>
                    ...
                    <div className="h-full overflow-y-auto scroll-smooth px-10">
                        <div className="space-y-5 pb-5">
                            ...
                            {/* Managing Schedules */}
                            <section id="schedules" className="space-y-6 py-5">
                                <div>
