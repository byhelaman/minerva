...
-- Filters by language (case-insensitive), can_evaluate, and/or eval_type.
...
GRANT EXECUTE ON FUNCTION public.chat_find_instructors(TEXT, BOOLEAN, TEXT) TO authenticated;
