...
-- ============================================
-- 1. Optimized get_schedules_report (select only frontend-needed columns)
--    Replaces 009_reports_rpc.sql which used SELECT * (broader payload).
-- 2. Batch delete RPC for schedule entries (eliminates N+1 requests)
